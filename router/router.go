...
func New() *gin.Engine {
	...
	admin.POST("/users/:id/status", func(c *gin.Context) {
		handler.AdminSetUserStatus(c.Writer, c.Request, c.Param("id"))
	})
	admin.DELETE("/users/:id", func(c *gin.Context) {
		handler.AdminDeleteUser(c.Writer, c.Request, c.Param("id"))
	})
	admin.GET("/invite-codes", gin.WrapF(handler.AdminInviteCodes))
	admin.POST("/invite-codes/generate", gin.WrapF(handler.AdminGenerateInviteCodes))
	admin.POST("/invite-codes/:id/status", func(c *gin.Context) {
		handler.AdminSetInviteCodeStatus(c.Writer, c.Request, c.Param("id"))
	})
