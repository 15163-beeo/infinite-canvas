...
export function InfiniteCanvas({ containerRef, viewport, backgroundMode = "lines", interactionMode = "select", onViewportChange, onCanvasMouseDown, onCanvasDeselect, onContextMenu, onDrop, children }: InfiniteCanvasProps) {
    ...
    const handlePointerDown = (event: React.PointerEvent<HTMLDivElement>) => {
        ...
        if (event.button === 0 && !isSpacePressed && interactionMode === "select" && isBackgroundClick) {
        ...
        if (event.button === 1 || (event.button === 0 && (isSpacePressed || interactionMode === "pan") && isBackgroundClick)) {
            event.preventDefault();
            event.currentTarget.setPointerCapture(event.pointerId);
            panState.current = {
                isPanning: true,
